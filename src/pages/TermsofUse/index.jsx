      ...
      <div>
        <div>
          ...
          <p>
            ...
            법정대리인의 동의여부 확인 목적으로 개인정보를 처리합니다. 2. 재화
            또는 서비스 제공 본인인증을 목적으로 개인정보를 처리합니다.
          </p>
          <h4>제2조(개인정보의 처리 및 보유 기간)</h4>
          <p>
            ① Fungap 은(는) 법령에 따른 개인정보 보유·이용기간 또는
            정보주체로부터 개인정보를 수집 시에 동의받은 개인정보 보유·이용기간
            내에서 개인정보를 처리·보유합니다. ② 각각의 개인정보 처리 및 보유
            기간은 다음과 같습니다. 1.&lt;홈페이지 회원가입 및 관리&gt;
            &lt;홈페이지 회원가입 및 관리&gt;와 관련한 개인정보는 수집.이용에
            관한 동의일로부터&lt;1년&gt;까지 위 이용목적을 위하여
            보유.이용됩니다. 보유근거 : 회원 관리 및 서비스 사용 권한 부여
            관련법령 : 예외사유 :
          </p>
          <h4>제3조(정보주체와 법정대리인의 권리·의무 및 그 행사방법)</h4>
          <p>
            ① 정보주체는 Fungap에 대해 언제든지 개인정보 열람·정정·삭제·처리정지
            요구 등의 권리를 행사할 수 있습니다. ② 제1항에 따른 권리
            행사는Fungap에 대해 「개인정보 보호법」 시행령 제41조제1항에 따라
            서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며
            Fungap은(는) 이에 대해 지체 없이 조치하겠습니다. ③ 제1항에 따른 권리
            ...
            없습니다. ⑥ Fungap은(는) 정보주체 권리에 따른 열람의 요구,
            정정·삭제의 요구, 처리정지의 요구 시 열람 등 요구를 한 자가
            본인이거나 정당한 대리인인지를 확인합니다.
          </p>
          <h4>제4조(처리하는 개인정보의 항목 작성)</h4>
          <p>
            ① Fungap 은(는) 다음의 개인정보 항목을 처리하고 있습니다. 1&lt;
            홈페이지 회원가입 및 관리 &gt; 필수항목 : 비밀번호, 로그인ID, 닉네임
            선택항목 : MBTI
          </p>
          <h4>제5조(개인정보의 파기)</h4>
          <p>
            ① Fungap 은(는) 개인정보 보유기간의 경과, 처리목적 달성 등
            ...
            다음과 같습니다. 1. 파기절차 &lt; Fungap &gt; 은(는) 파기 사유가
            발생한 개인정보를 선정하고, &lt; Fungap &gt; 의 개인정보
            보호책임자의 승인을 받아 개인정보를 파기합니다. 2. 파기방법 전자적
            파일 형태의 정보는 기록을 재생할 수 없는 기술적 방법을 사용합니다
          </p>
          <h4>제6조(개인정보의 안전성 확보 조치)</h4>
          <p>
            Fungap 은(는) 개인정보의 안전성 확보를 위해 다음과 같은 조치를
            취하고 있습니다. 1. 정기적인 자체 감사 실시 개인정보 취급 관련
            안정성 확보를 위해 정기적(분기 1회)으로 자체 감사를 실시하고
            있습니다. 2. 해킹 등에 대비한 기술적 대책
            &lt;Fungap&gt;(&#39;Fungap&#39;)은 해킹이나 컴퓨터 바이러스 등에
            의한 개인정보 유출 및 훼손을 막기 위하여 보안프로그램을 설치하고
            주기적인 갱신·점검을 하며 외부로부터 접근이 통제된 구역에 시스템을
            설치하고 기술적/물리적으로 감시 및 차단하고 있습니다. 3. 개인정보의
          ...
          <p>
            ① Fungap 은(는) 이용자에게 개별적인 맞춤서비스를 제공하기 위해
          ...
          <p>
            ① Fungap 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고,
            개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여
            아래와 같이 개인정보 보호책임자를 지정하고 있습니다. :앞쪽_화살표:
            개인정보 보호책임자 성명 :고수진 직책 :사원 직급 :사원 연락처
            :01090659080, soujinko@naver.com, ※ 개인정보 보호 담당부서로
            연결됩니다. :앞쪽_화살표: 개인정보 보호 담당부서 부서명 : 담당자 :
            연락처 :, , ② 정보주체께서는 Fungap 의 서비스(또는 사업)을
            이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제
            등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수
            있습니다. Fungap 은(는) 정보주체의 문의에 대해 지체 없이 답변 및
            처리해드릴 것입니다.
          </p>
          <h4>제9조(개인정보 열람청구)</h4>
          <p>
            정보주체는 ｢개인정보 보호법｣ 제35조에 따른 개인정보의 열람 청구를
            아래의 부서에 할 수 있습니다. &lt; Fungap &gt;은(는) 정보주체의
            개인정보 열람청구가 신속하게 처리되도록 노력하겠습니다.
            :앞쪽_화살표: 개인정보 열람청구 접수·처리 부서 부서명 :
            개인정보처리부서 담당자 : 고수진 연락처 : 01090659080,
            soujinko@naver.com,
          </p>
          ...
          <p>
            ① 이 개인정보처리방침은 2021년 8월 20부터 적용됩니다. ② 이전의
            개인정보 처리방침은 아래에서 확인하실 수 있습니다. 예시 ) - 20XX. X.
            X ~ 20XX. X. X 적용 (클릭) 예시 ) - 20XX. X. X ~ 20XX. X. X 적용
            (클릭) 예시 ) - 20XX. X. X ~ 20XX. X. X 적용 (클릭)
          </p>
        </div>
      </div>
      <button>동의합니다.</button>
